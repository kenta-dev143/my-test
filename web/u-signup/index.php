<?php
    ...
    if( _file_exists(_SYSTEM_ROOT_DIR."/u-signup/sub/" . $_request['page'] . '.php' ) ){
        $conn = _dbConnect();
        //_query( $conn, "begin" );
        ...
        require( _SYSTEM_ROOT_DIR."/u-signup/sub/" . $_request['page'] . '.php' );
    ...
    // Bladeで画面を表示
    // ******************************************************************************************************
    $blade->template_dir = _SYSTEM_ROOT_DIR."/views/u-signup";
