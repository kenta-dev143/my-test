<?php
    ...
    if( _file_exists(_SYSTEM_ROOT_DIR."/visit/sub/" . $_request['page'] . '.php' ) ){
        $conn = _dbConnect();
        //_query( $conn, "begin" );
        ...
        require( _SYSTEM_ROOT_DIR."/visit/sub/" . $_request['page'] . '.php' );
    ...
    // Smartyで画面を表示
    // ******************************************************************************************************
    $blade->template_dir = _SYSTEM_ROOT_DIR."/views/visit";
