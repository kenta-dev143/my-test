...
<title>{{ $event_rec['event_name'] }}-パスワード再設定</title>
...
<br>{{ $event_rec['event_name'] }}<span class="kaijyouNmae">({{ $event_rec['event_kaijyou_name'] }})</span>
</div>
  ...
  <div class="form-wrapper">
    ...
    <input type="hidden" name="token" value="{{ $token }}">
      <div class="form-item">
        ...
        <input type="text" name="login_id" value="{{ $login_id }}" required="required" placeholder="Email Address"></input>
      </div>
