...
<title>{{ $event_rec['event_name'] }}　{{ $disp_ymd }}-{{ $area_rec['area_name'] }}入口</title>
...
<div class="Venue_inner_wrap_mapage">
  <div class="form-wrapper">
    <h1 class="Venue-h">{{ $area_rec['area_name'] }}入口</h1>
  <form name="form_edit" action="./?page=area_in&area_id={{ $area_rec['area_id'] }}&ymd={{ $ymd }}" method="post">
