...
<title>{{ $event_rec['event_name'] }}　{{ $disp_ymd }}-会場出口</title>
...
<div class="Venue_inner_wrap_mapage">
  <div class="form-wrapper">
    <h1 class="Venue-h" style="font-weight:bold;font-size:30px;">会場出口</h1>
  <form name="form_edit" action="./?page=kaijyou_out&ymd={{ $ymd }}" method="post">
