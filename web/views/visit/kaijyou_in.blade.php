...
<div class="Venue_inner_wrap_mapage">
  <div class="form-wrapper">
    <h1 class="Venue-h" style="font-weight:bold;font-size:30px;">会場入口</h1>
  <form name="form_edit" action="./?page=kaijyou_in&ymd={{ $ymd }}" method="post">
  <input type="hidden" name="exec" value="qrread">
      ...
      <!-- <h2 class="Venue-h2" style="font-size:30px;">{{ $cnt }}人 入場中</h2> -->
  </form>
  @if($err_msg['0'] !='')
      <span style="color:red;">{{ $err_msg['0'] }}</span>
   @endif
  </div>
    <div id="thx_msg" style="text-align: center; display: none;">
        <span style="font-size: x-large; color: #1F85D8">ご来場ありがとうございます</span>
    </div>
</div>
<!--/#contents-->
