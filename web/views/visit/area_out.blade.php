...
<title>{{ $event_rec['event_name'] }}　{{ $disp_ymd }}-{{ $area_rec['area_name'] }}出口</title>
...
<div class="Venue_inner_wrap_mapage">
  <div class="form-wrapper">
    <h1 class="Venue-h">{{ $area_rec['area_name'] }}出口</h1>
  <form name="form_edit" action="./?page=area_out&area_id={{ $area_rec['area_id'] }}&ymd={{ $ymd }}" method="post">
