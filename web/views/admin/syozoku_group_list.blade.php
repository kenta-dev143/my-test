        ...
        <div class="row">
          <div class="col-md-4 pl-1">
            <div class="msr_text_01">
              ...
              <input type="text" name="szkgrp_name" value="{{ $search_condition['szkgrp_name'] }}"  style="width:50%;"/>を含む
            </div>
          </div>
          <div class="col-md-4 pl-1">
            <div class="msr_text_01">
...
<button type="button" onClick="location.href='?page=syozoku_group_edit';" class="btn btn-primary btn-round">新規登録</button>
            ...
            <table class="table">
              ...
              @foreach($main_recs as $rec)
                <tr>
                  ...
                  <td>
                  <button type="button" onClick="location.href='?page=syozoku_group_edit&id={{ $rec['szkgrp_id'] }}';" class="btn btn-primary btn-round">詳細</button>
                  </td>
                </tr>
               @endforeach
              </tbody>
