            ...
            -->
              ...
              <div class="row">
                <div class="col-md-4 pl-1">
                  ...
                  <div class="msr_radio_01">
                      <input type="checkbox" class="largechkbox" name="syoutai_yotei_time_ari" id="syoutai_yotei_time_ari" value="1" @if($search_condition['syoutai_yotei_time_ari']=="1")checked @endif/>
              ...
              <div class="row">
                ...
                <div class="col-md-4 pl-1">
                  <label>未登録企業</label>
                  <div class="msr_radio_01">
                    <input type="checkbox" class="largechkbox" name="ignore_mitouroku_flag" id="ignore_mitouroku_flag" value="1" @if($search_condition['ignore_mitouroku_flag']=="1")checked @endif/>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card" style="padding-top:10px;">
              ...
              　<br>
              <span style="font-weight:bold;font-size:16px;color:blue;">　承認対象者　<span id="taisyou_cnt_lbl">{!! $sentakuTaisyouCnt !!}</span>　名</span>
          ...
          <div class="row" style="margin:2px 10px 10px 30px;">
            <div class="col-md-4 pl-1">
              <label for="mail_tsuuchi">
                @if($login['admin_syuukei_etsuran_kengen']=="0")
                  <input type="checkbox" name="mail_tsuuchi" class="largechkbox" value="1" @if($mail_tsuuchi=="1")checked @endif id="mail_tsuuchi" />パスワード設定URLを
                  ...
                  メール通知する                  
                 @else 
                  <input type="checkbox" name="mail_tsuuchi" class="largechkbox" value="1" @if($mail_tsuuchi=="1")checked @endif id="mail_tsuuchi" />パスワード設定URLをメール通知する
            ...
            <div class="row">
              <div class="update _ml-auto _mr-auto">
                <button type="button" style="width:400px;margin-left:60px;" class="btn btn-primary btn-round" onClick="_doSave();">上記承認対象者(<span id="taisyou_cnt_btn">{{ $sentakuTaisyouCnt }}</span>名)を承認する</button>
              </div>
            </div>
          </div>
         @endif
