<?php
    ...
    // ******************************************************************************************************
    if($_request['ex']=="1"){
        $sm->template_dir = _SYSTEM_ROOT_DIR."/mypage/".$_request['evekey']."_templates/";
        $sm->config_dir   = _SYSTEM_ROOT_DIR."/mypage/".$_request['evekey']."_templates/";
    }else{
        $sm->template_dir = _SYSTEM_ROOT_DIR."/mypage/templates/";
        $sm->config_dir   = _SYSTEM_ROOT_DIR."/mypage/templates/";
    }
