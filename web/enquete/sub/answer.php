        ...
        case 'save':
            ...
            if( _count( $err_msg ) == 0 ){
                ...
                if( _count($ans_recs) > 0 ){
                    _update('t_jigo_answer', $array, "jigo_event_id = '" . _as($event_rec['event_id']) . "' and jigo_user_id = '" . _as($_SESSION[_PROJECT_NAME]['user_login']['user_id']) . "'");
                } else {
