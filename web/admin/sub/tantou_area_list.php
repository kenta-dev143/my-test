<?php
    ...
    if( $_request['exec'] == "search"){
        ...
        unset( $this_sess['search_condition'] );
        $this_sess['search_condition']['order_by'] = "tanarea_id asc";
    }
    ...
    // ******************************************************************************************************
    // $order_by_arr = array();
    // $order_by_arr['tanarea_id asc'] = "所属ID順";
    ...
    // --------------------------------------------------- //
    $where = "";
    $where .= "tanarea_delete_date is null";

    // --------------------------------------------------- //
    // 検索条件
    // --------------------------------------------------- //
    if($this_sess['search_condition']['tanarea_name'] !=""){
        $where .= " and tanarea_name like '%"._as( $this_sess['search_condition']['tanarea_name'] )."%'";
    }
    ...
    // 件数取得SQL
    $sql  = "";
    $sql .= " select count(m_tantou_area.tanarea_id) as all_cnt "."\n";
    ...
    $contents_title = "担当エリア管理";
    $active_menu = "tantou_area_list";
    $contents_tpl = "tantou_area_list";
