<?php
    ...
    $_conf_rsignup_big_cate1[3] = "メーカー";
    $_conf_rsignup_big_cate1[4] = "その他";
    $blade->assign('_conf_rsignup_big_cate1', $_conf_rsignup_big_cate1);

    $_conf_rsignup_mid_cate = array();
    $_conf_rsignup_mid_cate[35] = "商社／卸";
    $_conf_rsignup_mid_cate[99] = "その他";
    $blade->assign('_conf_rsignup_mid_cate', $_conf_rsignup_mid_cate);
    ...
    switch( $_request['exec'] ){
        ...
        case 'pre_save':
            if( _count( $this_sess ) <= 0 ){
                ...
                $hontouroku_url = _SYSTEM_ROOT_URLS."/s-signup/".$event_rec['event_url_key']."/?exec=regist&iu=".$ango;
        ...
        case 'confirm':
            ...
            if ( $this_sess['rsup_id'] == '' ){
                ...
                if (isset($_request['user_big_cate']) && $_request['user_big_cate'] != '3') {
                    $chks["user_mid_cate,中分類"] = "need";
                }
            ...
            if( _count( $err_msg ) == 0 ){
                ...
                if ($this_sess['user_big_cate'] == "3") {
                    $this_sess['disp_user_mid_cate'] = "メーカー";
                } else {
                    $this_sess['disp_user_mid_cate'] = $_conf_rsignup_mid_cate[$this_sess['user_mid_cate']];
                }
        ...
        case 'save':
            if( _count( $this_sess ) <= 0 ){
                ...
                //中分類
                if($this_sess['user_big_cate']=="3"){
                    $array['user_mid_cate']            = "40"; //中分類(40:(招待者)メーカー)
                }elseif($this_sess['user_big_cate']=="4"){
                    $array['user_mid_cate']            = "'"._as($this_sess['user_mid_cate'])."'";
                }
