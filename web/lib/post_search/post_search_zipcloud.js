...
function _postSearchZipCloudApi(arg_post_code,arg_todoufuken_id,arg_todoufuken_type,arg_address1,arg_address2){
    ...
    //*** replaceした文字列
    var re_def_post = arg_post_code.replace("-","");
    //NULL Check
    if(re_def_post == ""){
        alert("郵便番号を入力してください。");
        err_flg = true;
    ...
    //郵便番号検査
    if(err_flg == false){
        var url = base_path + '/post_search_zipcloud.php';
