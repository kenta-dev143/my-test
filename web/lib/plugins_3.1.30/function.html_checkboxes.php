...
function smarty_function_html_checkboxes($params, $template)
{
    ...
    $label_ids = false;
    $output = null;
    $break_separator = '';             //2017/04/10 K-Creation Add
    $break_separator_interval = 1;     //2017/04/10 K-Creation Add
    ...
    foreach ($params as $_key => $_val) {
        switch ($_key) {
            ...
            case 'break_separator':                //2017/04/10 K-Creation Add
                $$_key = $_val;                    //2017/04/10 K-Creation Add
                break;                            //2017/04/10 K-Creation Add

            case 'break_separator_interval':    //2017/04/10 K-Creation Add
                $$_key = $_val;                    //2017/04/10 K-Creation Add
                break;                            //2017/04/10 K-Creation Add
    ...
    $cnt = 0; //2017/04/10 K-Creation Add
    if (isset($options)) {
        foreach ($options as $_key => $_val) {
            //2017/04/10 K-Creation Mod ------ Before ------
            // $_html_result[] =
            //     smarty_function_html_checkboxes_output($name, $_key, $_val, $selected, $extra, $separator, $labels,
            //                                            $label_ids, $escape);
            //2017/04/10 K-Creation Mod ------ After ------
            $cnt++;
            ...
            $_html_result[] =
                smarty_function_html_checkboxes_output($name, $_key, $_val, $selected, $extra, $w_sep, $labels,
                                                       $label_ids, $escape);
            //2017/04/10 K-Creation Mod ------ End ------
        }
    } else {
