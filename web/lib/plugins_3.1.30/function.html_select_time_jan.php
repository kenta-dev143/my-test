 ...
 *
 * @link     http://www.smarty.net/manual/en/language.function.html.select.time.php {html_select_time_jan}
 ...
 */
function smarty_function_html_select_time_jan($params)
{
    $prefix = "Time_";
    $field_array = null;
    $field_separator = "\n";
        ...
        switch ($_key) {
            ...
            default:
                if (!is_array($_value)) {
                    ...
                    //2017/04/10 Mod
                    trigger_error("html_select_time_jan: extra attribute '$_key' cannot be an array", E_USER_NOTICE);
                }
                break;
        }
    }
