...
/**
 * Smarty {html_select_date_jan} plugin
 * Type:     function<br>
 * Name:     html_select_date_jan<br>
 ...
 * </pre>
 *
 * @link     http://www.smarty.net/manual/en/language.function.html.select.date.php {html_select_date_jan}
 ...
 * @return string
 */
function smarty_function_html_select_date_jan($params)
{
        ...
        switch ($_key) {
            ...
            case 'month_names':
                if (is_array($_value) && count($_value) == 12) {
                    ...
                    //2017/04/10 Mod
                    trigger_error("html_select_date_jan: month_names must be an array of 12 strings", E_USER_NOTICE);
                }
                break;
            ...
            default:
                if (!is_array($_value)) {
                    ...
                    //2017/04/10 Mod
                    trigger_error("html_select_date_jan: extra attribute '$_key' cannot be an array", E_USER_NOTICE);
                }
                break;
        }
    }
    ...
    if( strlen($start_year) < 4 ) $start_year = "+".$start_year;
    if( strlen($end_year) < 4 ) $end_year = "+".$end_year;
    //2017/04/10 Add ------- End ---------
